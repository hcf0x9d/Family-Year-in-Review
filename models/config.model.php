...
if(in_array($host, array('local','127.0','192.1', 'yir.d')) || $_SERVER['HTTP_HOST'] == $localHost) {
    $local = true;
} else {
    $local = false;
}
...
if ($local) {
    ...
    define('BASE_URI', 'C:\xampp\htdocs\Family-Year-in-Review');
    define('BASE_URL', 'http://yir.dev');
